...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      martingale_pause_events: {
        Row: {
          anchor_ce_premium: number | null
          anchor_pe_premium: number | null
          ce_drop_pct: number | null
          gate_eval: Json
          gate_round: number | null
          id: string
          nifty_range_pts: number | null
          nifty_spot: number | null
          otm_ce_at_pause: number | null
          otm_ce_strike: number | null
          otm_pe_at_pause: number | null
          otm_pe_strike: number | null
          pause_kind: string
          pause_until: string
          pe_drop_pct: number | null
        ...
        Relationships: [
          {
            foreignKeyName: "martingale_pause_events_session_id_fkey"
            columns: ["session_id"]
            isOneToOne: false
